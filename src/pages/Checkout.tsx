...
import {
  ArrowLeft, BadgeCheck, Check, Lock, Smartphone, Tag, Truck, Wallet,
} from 'lucide-react'
...
const PAYMENTS: { id: PaymentMethod; label: string; sub: string; icon: typeof Smartphone }[] = [
  { id: 'mtn', label: 'MTN Mobile Money · ZengaPay', sub: 'Secure prompt powered by ZengaPay', icon: Smartphone },
  { id: 'airtel', label: 'Airtel Money · ZengaPay', sub: 'Secure prompt powered by ZengaPay', icon: Smartphone },
              ...
              {step === 0 && (
                <section className="rounded-2xl bg-card p-6 sm:p-8">
                  ...
                  <div className="mt-6 grid gap-4 sm:grid-cols-2">
                    ...
                    {field('town', 'Town / suburb (optional)', { placeholder: 'Ntinda' })}
                    <div className="sm:col-span-2">
              ...
              {step === 1 && (
                <section className="rounded-2xl bg-card p-6 sm:p-8">
                  ...
                  <p className="mt-5 flex items-center gap-2 text-[12px] text-text-muted">
                    ...
                    {API_ENABLED ? 'Payments are securely initiated through ZengaPay.' : 'Demo mode — no real payment is processed.'}
                  </p>
